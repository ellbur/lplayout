...
let nodeMetrics: SVGGraph.nodeMetrics = {
  nodeBorderStrokeWidth: "1px",
  nodeHorizontalPadding: 20.0,
  nodeVerticalPadding: 10.0,
  nodeFontSize: "16pt",
  nodeFontFamily: "'Noto Sans'",
  nodeSideTextFontSize: "16pt",
  nodeSideTextFontFamily: "'Noto Sans'",
  nodeSideTextXOffset: 5.0,
  nodeRoundingX: 3.0,
  nodeRoundingY: 3.0,
}

let edgeMetrics: SVGGraph.edgeMetrics = {
  edgeStrokeWidth: "1px",
...
let renderGraph = (~document: Document.t, ~svg: Element.t, ~graph: SVGGraph.graph) => {
  ...
  
  {
    ...
    nodes->Belt.Array.forEach(({id, nodeMetrics, text: nodeText}) => {
      ...
      let rectWidth = textWidth +. nodeHorizontalPadding *. 2.0
      let rectHeight = textHeight +. nodeVerticalPadding *. 2.0
